...
workflow CELLCONSENSUS {
    ...
    softwareVersionsToYAML(ch_versions.mix(topic_versions.versions_file))
        ...
        .collectFile(
            ...
            name: 'nf_core_'  +  'cellconsensus_software_'  + 'mqc_'  + 'versions.yml',
            sort: true,
            newLine: true
    ...
    emit:multiqc_report = ch_multiqc_report.toList() // channel: /path/to/multiqc_report.html
